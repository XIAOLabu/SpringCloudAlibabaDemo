...
public class DateTimeUtils {
     ...
     * @return 2019-08-27
     */
    public static String getDateByStringNew() {
        Date date = new Date();
    ...
    public static String getCurrentHour() {
        ...
        if (hour < 10) {
            return DateTimeUtils.getCurrentTime() + " 0" + hour;
        }
        return DateTimeUtils.getDateByString() + " " + hour;
    }
    ...
    public static String getCurrentHourBefore() {
        ...
        if (hour > 0) {
            ...
            if (hour < 10) {
                return DateTimeUtils.getDateByString() + " 0" + hour;
            }
            return DateTimeUtils.getDateByString() + " " + hour;
        }
        //获取当前日期前一天
        return DateTimeUtils.getBeforeDay() + " " + 23;
    }
    ...
    public static void main(String[] args) {
        System.out.println(DateTimeUtils.getSystemTime());
        System.out.println(DateTimeUtils.getCurrentTime());
        System.out.println(DateTimeUtils.getDateByStringNew());
    }
